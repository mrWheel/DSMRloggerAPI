 ...
 */
#define DECLARE_TIMER_MIN(timerName, timerTime)  static uint32_t timerName##_interval = (timerTime * 60 * 1000), timerName##_last = millis()+random(timerName##_interval);
#define DECLARE_TIMER(timerName, timerTime)      static uint32_t timerName##_interval = (timerTime * 1000),      timerName##_last = millis()+random(timerName##_interval);
#define DECLARE_TIMER_MS(timerName, timerTime)   static uint32_t timerName##_interval = timerTime,               timerName##_last = millis()+random(timerName##_interval);
